...
## Environments
- Preview: https://main--docbased-boilerplate--lovelymandal16.hlx.page/
- Live: https://main--docbased-boilerplate--lovelymandal16.hlx.live/
...
1. Open the `docbased-boilerplate` directory in your favorite IDE and start coding :)
